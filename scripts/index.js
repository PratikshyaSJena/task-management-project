    ...
    <div class='col-md-6 col-lg-4 mt-3' id=${id} key${id}>
        <div class='card shadow-sm task__card'>
            ...
            <div class='card-body'>
                ${
                    url ?
                    `<img width='100%' height='180px' style="object-fit: cover; object-position: center" src=${url} alt='card image cap' class='card-image-top md-3 rounded-lg'/>`
                    :
                    `<img width='100%' height='180px' style="object-fit: cover; object-position: center" src="https://reactnativecode.com/wp-content/uploads/2018/02/Default_Image_Thumbnail.png" alt='card image cap' class='img-fluid place__holder__image mb-3' />`
                }
            ...
            <div class='card-footer'>
                <button type='button' class='btn btn-outline-primary float-right' 
                        data-bs-toggle='modal' data-bs-target='#showTask' id=${id} 
...
const handleSubmit = (event) => {
    ...
    if (input.title === "" || input.description === "" || input.type === "") {
        return alert("Plaese fill all the fields");
    }
